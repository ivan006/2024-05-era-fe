...
export default class DBVenueState extends DBBaseModel {
    ...
    static FetchAll(options) {
        return this.customSupabaseApiFetchAll(
            `${this.baseUrl}/rest/v1/venue_states`,
            [],
    ...
    static FetchById( options = { flags: {}, moreHeaders: {}, rels: [] }, id, relationships = []) {
        ...
        return this.customSupabaseApiFetchById(
            ...
            `${this.baseUrl}/rest/v1/venue_states?id=eq.${id}&select=*`,
            id,
            relationships
        )
    }
    ...
    static Store(entity, options = { flags: {}, moreHeaders: {}, rels: [] } ) {
        return this.customSupabaseApiStore(
            this.mergedOptions(options),
            `${this.baseUrl}/rest/v1/venue_states?select=*`,
            entity
        )
    }
    ...
    static Upsert(entity) {
        return this.customSupabaseApiUpsert(
            `${this.baseUrl}/rest/v1/venue_states?on_conflict=name,parent_id`,
            entity
        )
    }
    ...
    static Update(entity, options = { flags: {}, moreHeaders: {}, rels: [] } ) {
        return this.customSupabaseApiUpdate(
          this.mergedOptions(options),
            `${this.baseUrl}/rest/v1/venue_states?id=eq.${entity.id}&select=*`,
            entity
        )
    }
    static Delete(entityId, options = { flags: {}, moreHeaders: {}, rels: [] } ) {
        return this.customSupabaseApiDelete(
          this.mergedOptions(options),
            `${this.baseUrl}/rest/v1/venue_states?id=eq.${entityId}`,
            entityId
        )
    }
}
